        ...
        <main>
            <section class="section2">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>店铺统计</el-breadcrumb-item>
                </el-breadcrumb>
                <div :style="'height:'+fullHeight+'px;'">
                    <div class="tablecolor">
                        <div class="tr">
                                <div style="width: 40%">店铺</div>
                                <div style="width: 20%">商品数量</div>
                                <div style="width: 20%">销售量</div>
                                <div style="width: 20%">销量额</div>
                            </div>
                        <div v-for="i in shopslist" :key="i.id" class="tablemain">
                            <span style="width: 40%">{{i.name}}</span>
                            <span style="width: 20%">{{i.price}}</span>
                            <span style="width: 20%">{{i.inventory}}</span>
                            <span style="width: 20%">{{i.inventory}}</span>
