                ...
                <div :style="'height:'+fullHeight+'px;'">
                    <div class="tablecolor">
                        <div class="tr">
                            ...
                            <div style="width: 14%">订单用户</div>
                            <div style="width: 14%">订单时间</div>
                            <div style="width: 14%">订单内容</div>
                            <div style="width: 14%">订单价格</div>
                            <div style="width: 14%">订单备注</div>
                        </div>
                        <div v-for="i in shopslist" :key="i.id" class="tablemain">
                            ...
                            <span style="width: 14%">{{i.comment}}</span>
                        </div>
                    </div>
                </div>
            </section>
